                    ...
                    Group.findGroups FindPartials (Tile.tilesFromString "1234579m446789p3s")
                        |> Expect.equal
                            { perSuit =
                                ...
                                , pin = [ [ Pair P4 P4, PartialKanchan P6 P8, PartialKanchan P7 P9 ], [ Pair P4 P4, PartialPenchan P6 P7, PartialPenchan P8 P9 ], [ PartialKanchan P4 P6, Run P7 P8 P9 ] ]
                                , sou = []
                                , honor = []
                                }
                            }
            , test "4321. 3555778m2356p35s4z" <|
                \_ ->
                    Group.findGroups FindPartials (Tile.tilesFromString "3555778m2356p35s4z")
                        |> Expect.equal
                            { perSuit =
                                { man = [ [ PartialKanchan (M5 False) M7, Pair (M5 False) (M5 False), PartialPenchan M7 M8 ], [ Pair (M5 False) (M5 False), PartialKanchan (M5 False) M7, PartialPenchan M7 M8 ], [ PartialKanchan M3 (M5 False), Pair (M5 False) (M5 False), PartialPenchan M7 M8 ], [ Triplet (M5 False) (M5 False) (M5 False), PartialPenchan M7 M8 ] ]
                    ...
                    Group.findGroups FindPartials (Tile.tilesFromString "1679m89p12557789s")
                        |> Expect.equal
                            { perSuit =
                                ...
                                , sou = [ [ PartialPenchan S1 S2, PartialKanchan (S5 False) S7, PartialKanchan (S5 False) S7, PartialPenchan S8 S9 ], [ PartialPenchan S1 S2, PartialKanchan (S5 False) S7, Run S7 S8 S9 ], [ PartialPenchan S1 S2, Pair (S5 False) (S5 False), PartialKanchan S7 S9, PartialPenchan S7 S8 ], [ PartialPenchan S1 S2, Pair (S5 False) (S5 False), PartialPenchan S7 S8, PartialKanchan S7 S9 ] ]
                                , honor = []
                                }
                            }
                    ...
                    Group.findGroups FindPartials (Tile.tilesFromString "6779m12556778s46z")
                        |> Expect.equal
                            { perSuit =
                                ...
                                , pin = []
                                , sou = [ [ PartialPenchan S1 S2, PartialKanchan (S5 False) S7, PartialKanchan (S5 False) S7, PartialKanchan S6 S8 ], [ PartialPenchan S1 S2, PartialKanchan (S5 False) S7, PartialPenchan (S5 False) S6, PartialPenchan S7 S8 ], [ PartialPenchan S1 S2, PartialPenchan (S5 False) S6, PartialKanchan (S5 False) S7, PartialPenchan S7 S8 ], [ PartialPenchan S1 S2, PartialKanchan (S5 False) S7, Run S6 S7 S8 ], [ PartialPenchan S1 S2, PartialKanchan (S5 False) S7, Run (S5 False) S6 S7 ], [ PartialPenchan S1 S2, Run (S5 False) S6 S7, PartialPenchan S7 S8 ], [ PartialPenchan S1 S2, Run (S5 False) S6 S7, PartialKanchan (S5 False) S7 ], [ PartialPenchan S1 S2, Pair (S5 False) (S5 False), PartialKanchan S6 S8, Pair S7 S7 ] ]
                                , honor = []
                                }
                            }
                    ...
                    Group.findGroups FindPartials (Tile.tilesFromString "479m234556p6889s7z")
                        |> Expect.equal
                            { perSuit =
                                ...
                                , pin = [ [ PartialKanchan P2 P4, PartialKanchan P3 (P5 False), PartialPenchan (P5 False) P6 ], [ PartialPenchan P2 P3, PartialPenchan P4 (P5 False), PartialPenchan (P5 False) P6 ], [ PartialKanchan P3 (P5 False), Run P4 (P5 False) P6 ], [ Run P3 P4 (P5 False), PartialPenchan (P5 False) P6 ], [ PartialPenchan P2 P3, Run P4 (P5 False) P6 ], [ Run P2 P3 P4, PartialPenchan (P5 False) P6 ], [ PartialPenchan P2 P3, PartialKanchan P4 P6, Pair (P5 False) (P5 False) ] ]
                    ...
                    Group.findGroups FindPartials (Tile.tilesFromString "24m567p122467889s")
                        |> Expect.equal
                            { perSuit =
                                ...
                                , pin = [ [ Run (P5 False) P6 P7 ], [ PartialPenchan P6 P7 ], [ PartialKanchan (P5 False) P7 ], [ PartialPenchan (P5 False) P6 ] ]
                                , sou = [ [ PartialPenchan S1 S2, PartialKanchan S2 S4, PartialKanchan S6 S8, Run S7 S8 S9 ], [ PartialPenchan S1 S2, PartialKanchan S2 S4, Run S6 S7 S8, PartialPenchan S8 S9 ], [ Pair S2 S2, PartialKanchan S4 S6, PartialKanchan S7 S9, Pair S8 S8 ] ]
                                , honor = []
                                }
                            }
                    ...
                    Group.findGroups FindPartials (Tile.tilesFromString "25668m224456p157s")
                        |> Expect.equal
                            { perSuit =
                                ...
                                , pin = [ [ PartialKanchan P2 P4, PartialKanchan P2 P4, PartialPenchan (P5 False) P6 ], [ PartialKanchan P2 P4, Run P4 (P5 False) P6 ], [ Pair P2 P2, PartialKanchan P4 P6, PartialPenchan P4 (P5 False) ], [ Pair P2 P2, PartialPenchan P4 (P5 False), PartialKanchan P4 P6 ] ]
